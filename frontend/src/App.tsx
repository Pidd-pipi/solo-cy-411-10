...
import { AuditOutlined, BarChartOutlined, FieldTimeOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/templates', icon: <FieldTimeOutlined />, label: '周期模板' },
